...
const SuccessMessage = ( { children, onClose } ) => {
    ...
    const handleClick = ( e ) => {
        ...
        // after closing the success message, reset the userUpdatePasswordSuccess to false and
        // we can do that by calling onClose(); in this component and this will call the
        // onClose function in the profile.js file and thereby reset the
        // userUpdatePasswordSuccess to false
        onClose();
